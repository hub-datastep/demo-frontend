...
export const AdminModal: FC<IAdminModal> = ({ adminModalFunctions, databasePredictionConfig }) => {
  ...
  const updateDatabasePredictionConfigMutation = useMutation(
    ...
    <>
      <Modal onClose={onClose} size="full" isOpen={true}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <FormControl>
              <HStack alignItems="center">
                ...
                <Tooltip
                  ml="5"
                  label="Повышает точность ответа, но ответ генерируется дольше."
                  aria-label="alternative questions tooltip"
                >
                  <QuestionIcon />
                </Tooltip>
                <Switch
                  ...
                  onChange={(event) =>
                    queryClient.setQueryData<DatabasePredictionConfigModel>(
              ...
              <HStack mt="5">
                ...
                <Tooltip
                  label="Вы сможете проверить логику получения ответа, но ответ будет генерироваться дольше."
                  aria-label="alternative questions tooltip"
                >
                  <QuestionIcon />
                </Tooltip>
              ...
              <HStack mt="5">
                ...
                <Tooltip
                  label="Не влияет на скорость получения ответа."
                  aria-label="alternative questions tooltip"
                >
                  <QuestionIcon />
                </Tooltip>
          ...
          <ModalFooter gap="5">
            <Button
              onClick={handleSaveDatabasePredictionConfig}
              isLoading={updateDatabasePredictionConfigMutation.isLoading}
            >
              Сохранить
            </Button>
